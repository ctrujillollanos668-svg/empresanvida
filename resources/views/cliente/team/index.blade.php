...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-br from-slate-900 via-slate-900 to-cyan-950/40 border border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-3 mt-4">
            @php
                $shareText = urlencode("¡Únete a mi equipo en PYRAMID VIP y gana rendimientos diarios en pesos colombianos! Regístrate aquí: " . url('/register?ref=' . $user->referral_code));
            @endphp
